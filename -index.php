...
<html lang="en">
<head>
    <!-- Vlad Ansible managed: /Applications/vlad-master/vlad/playbooks/templates/index.j2 modified on 2015-05-08 14:17:56 by prebenh on HI36750.local -->
    <meta charset="utf-8">
...
<div class="row">
    <div class="col-lg-6">
        ...
        replacing everything in the <var>/Users/prebenh/Documents/sites/matukio</var> directory or by using one of the two
        ...
        <p>Out of the box Vlad is ready to run a Drupal site. Simply put the code in the <var>/Users/prebenh/Documents/sites/matukio</var> directory and run either use the >web installer or install the site using drush:</p>
        <pre class="prettyprint linenums">
$ cd /var/www/site//Users/prebenh/Documents/sites/matukio
$ drush site-install profile_name --db-url=mysql://admin:admin@localhost/['matukio'] --account-name=admin --account-pass=password --yes
</pre>
        ...
        <p>Go to <a href="//matukio.dev">matukio.dev</a> in your browser and the site is rocking.</p>

        <h3>Developing</h3>
        <p>All your files are actually located on your host machine in the <var>/Users/prebenh/Documents/sites/matukio</var>-directory
...
$ vagrant ssh
            ...
            <div class="panel-body">
                ...
                <dl>
                    ...
                    <dd>XDebug is a PHP debugging and profiling tool. To use the debugger, point your IDE at this
                        ...
                        <a href="http://matukio.dev/?XDEBUG_PROFILE=true">http://matukio.dev/?XDEBUG_PROFILE=true</a>).
                    </dd>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <p>Yes, it is easy to run several sites on the same box. You just put them in different folders in <var>/var/www/site//Users/prebenh/Documents/sites/matukio/</var>.
                You can create new databases using <a
                        href="http://adminer.matukio.dev:8080/?username=vlad">Adminer</a></p>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="col-lg-6">
                ...
                <p>MySQL can be administered with <a href="http://adminer.matukio.dev/">Adminer</a>. But also
                    directly
